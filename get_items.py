...
def generate_js_output(sorted_items, pipe_positions, heat_positions, fluid_recipes):
...
def format_item_entry(item_name, item_data):
    ...
    props = {
        "selectionBox": item_data['selection_box'],
        "collisionBox": item_data['collision_box'],
        "size": item_data['size'],
...
def main():
    ...
    js_output = generate_js_output(sorted_items, item_to_pipe_target_positions, 
                                 item_to_heat_target_positions, fluid_recipes)
