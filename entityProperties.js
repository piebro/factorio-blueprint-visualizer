...
const entityNameToProperties = {
    ...
    "curved-rail-a": {'genericTerms': ['logistics', 'train-transport']},
    "curved-rail-b": {'genericTerms': ['logistics', 'train-transport']},
    "elevated-curved-rail-a": {'genericTerms': ['logistics', 'train-transport']},
    "elevated-curved-rail-b": {'genericTerms': ['logistics', 'train-transport']},
    "elevated-half-diagonal-rail": {'genericTerms': ['logistics', 'train-transport']},
    "elevated-straight-rail": {'genericTerms': ['logistics', 'train-transport']},
    "half-diagonal-rail": {'genericTerms': ['logistics', 'train-transport']},
    ...
    "straight-rail": {'genericTerms': ['logistics', 'train-transport']},
